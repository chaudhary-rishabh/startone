...
export default function HeroSection() {
  return (
    <section className="relative bg-grid-lines sm:mt-20 min-h-screen flex flex-col items-center justify-center px-4 md:px-6 overflow-hidden pt-24 md:pt-0">
      ...
      {/* Main Content */}
      <div className="text-center sm:mt-8 max-w-4xl mx-auto relative z-10 flex-1 flex flex-col justify-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button className="bg-gray-900 hover:bg-gray-800 text-white px-6 md:px-8 py-3 md:py-4 rounded-xl text-base md:text-lg flex items-center space-x-2 w-full sm:w-auto">
      ...
      <div className="relative z-10 mb-8 md:mb-16 md:mt-10">
